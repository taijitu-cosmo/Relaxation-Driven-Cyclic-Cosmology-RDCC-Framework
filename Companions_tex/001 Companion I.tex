...
\subsection{Global Wave Structure and Local Particle Projection}

A fundamental consequence of the bipartite Hilbert-space structure of RDCC is that the global
CPT-symmetric state is intrinsically wave-like, while the physics perceived by a sectoral observer
is intrinsically particle-like. This resolves the wave–particle duality as a structural projection
effect rather than a fundamental dichotomy.

The global state
\begin{equation}
    |\Psi\rangle \in \mathcal{H}_+ \otimes \mathcal{H}_-
\end{equation}
is a pure, coherent, CPT-invariant quantum state. It exhibits global interference, long-range
correlations, and time-symmetric evolution. No notion of localized particles exists at the global
level; the state is fully wave-like.

A sectoral observer, however, perceives only the reduced density matrix
\begin{equation}
...
$\mathcal{H}_-$ induces decoherence and suppresses global interference terms. The resulting
sectoral physics appears particle-like, localized, and effectively classical. In this framework, the
apparent collapse of the wavefunction is not a dynamical process at all, but a pure projection
effect arising from the restriction of the global CPT-symmetric state to a single sector. No
additional collapse postulate is required.

This leads to the structural correspondence
\begin{equation}
    \text{global: wave-like, coherent, CPT-symmetric}
    \quad\longrightarrow\quad
    \text{local: particle-like, decohered, time-oriented}.
\end{equation}

The relaxation parameter $\alpha$ can be interpreted as a measure of the residual inter-sectoral
entanglement that survives the sectoral projection. In the infrared, $\alpha \to 0$ corresponds to
maximal global coherence, while nonzero $\alpha$ quantifies the degree of entanglement leakage
between the sectors. This connects the wave–particle correspondence directly to the relaxation
dynamics governing the cosmological evolution.

At the bounce, where $\alpha(t_b) = 0$ and the two sectors become maximally correlated, the
global wave-like character of the state is fully restored. Sectoral decoherence vanishes, the
thermodynamic arrows of time momentarily disappear, and the effective particle-like description
breaks down. For an infinitesimal moment, the Universe exists purely as a globally coherent
CPT-symmetric wave state. The sectoral classical world re-emerges only once $\alpha$ grows away
from zero after the bounce, reintroducing decoherence and restoring the particle-like appearance
of matter.

This structural perspective aligns naturally with other RDCC dualities:
\begin{itemize}
    \item global CPT symmetry vs.\ sectoral thermodynamic arrows of time,
    \item global unitarity vs.\ sectoral irreversibility,
    \item global nonsingular bounce vs.\ sectoral apparent singularities,
    \item global tensor interference vs.\ sectoral gravitational-wave observables.
\end{itemize}

The wave–particle duality is therefore not an additional postulate, but a structural consequence
of the bipartite CPT-symmetric architecture of RDCC. The world is globally wave-like, while
particles emerge as sectoral projections of the global CPT-symmetric state.
